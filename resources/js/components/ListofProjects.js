                ...
                {projects.map(project => (
                    <ListItem button component={Link} to={`/${project.id}`} key={project.id} >
                        ...
                        <ListItemSecondaryAction>
                            <Chip label={project.is_completed ? "completed" : "not completed"} style={{
                                backgroundColor: project.is_completed ? "#009688" : "tomato",
                                color: "#fff",
                                marginRight: 7
                            }} color="primary" variant="outlined" />
                            <Chip label={project.tasks_count} color="primary" variant="outlined" />
                            <Chip label="X" color="danger" variant="outlined" onClick={() => {
